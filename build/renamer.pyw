...
class MainFrame(tk.Frame):
    def __init__(self, root):
        ...
        btn_action = tk.Button(self, text="Reemplazar", command=self.rename_files, width=10, pady=5)
        btn_action.grid(row=6, column=1, sticky=tk.E)
        btn_action.grid(padx=5, pady=5)
        btn_quit = tk.Button(self, text="Salir", command= self.quit, width=10, padx=5, pady=5)
        btn_quit.grid(row=6, column=2, sticky=tk.W)
        btn_quit.grid(padx=5, pady=5)
